...
#!/bin/bash
wget -O /usr/local/sbin/jho/active.sh http://206.189.34.245/app/prem
wget -O /usr/local/sbin/jho/inactive.sh http://206.189.34.245/app/xprem
wget -O /usr/local/sbin/jho/deleted.sh http://206.189.34.245/app/deleted
