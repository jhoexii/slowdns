...
organization=Jsoft.com
organizationalunit=Jsoft.com
commonname=Jsoft.com
email=admin@Jsoft.com
...
# Custom Banner SSH
echo "================  Banner ======================"
wget -O /etc/issue.net "https://raw.githubusercontent.com/jhoexii/slowdns/main/banner.conf"
