...
read -rp "domain ex. jsoft.com: " -e domain

read -rp "subdomain ex. sg1: " -e sub
...
[Unit]
Description=Client SlowDNS By Jsoft
Documentation=https://Jsoft.com
...
[Unit]
Description=Server SlowDNS By Jsoft
Documentation=https://Jsoft.com
After=network.target nss-lookup.target
